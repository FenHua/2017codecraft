...
//得到初始解
//暴力选取初始server
extern void initial_server(int num_user, int num_point, int server_cost, int*user, int*user_w, int**matrix_w,server_inf&server);
//得到初始解
...
//test
extern void Iteration(int num_user, int num_point, int server_cost, int*user, int*user_w, int**matrix_w,pathinf&path, char*filename);
