...
int GetData(int line_num, int num_user, int num_point, int num_edge, char*topo[], int **matrix_w,int*user_w, int*user)
{
...
void FLOW(int num_user,int num_point,MCMF&temp,int**w)
{
